...
const config = {
    serverInfo: {
        ...
        serverIp: "15.204.180.39:20690", /*Server IP (if you want to add online user counter, you must have true the enable-status and enable-query of server.properties)*/
